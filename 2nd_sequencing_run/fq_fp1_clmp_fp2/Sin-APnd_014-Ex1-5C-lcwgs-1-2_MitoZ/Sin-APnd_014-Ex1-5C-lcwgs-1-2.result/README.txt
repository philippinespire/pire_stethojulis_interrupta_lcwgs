...
File:
Sin-APnd_014-Ex1-5C-lcwgs-1-2_mitoscaf.fa.val
errorsummary.val
...
File:
Sin-APnd_014-Ex1-5C-lcwgs-1-2_mitoscaf.fa.gbf

- 4. The mitochondrial genome in Fasta format.
File:
Sin-APnd_014-Ex1-5C-lcwgs-1-2.fasta
...
the file Sin-APnd_014-Ex1-5C-lcwgs-1-2_mitoscaf.fa.gbf has no annotation problem.
File:
Sin-APnd_014-Ex1-5C-lcwgs-1-2_mitoscaf.fa.sqn

- 7. The feature table for the mitochondrial genome.
File:
Sin-APnd_014-Ex1-5C-lcwgs-1-2_mitoscaf.fa.tbl
...
File:
Sin-APnd_014-Ex1-5C-lcwgs-1-2.cds

- 9. The rRNA gene sequences for each rRNA gene.
File:
Sin-APnd_014-Ex1-5C-lcwgs-1-2.rrna

- 10. The tRNA gene sequences for each tRNA gene.
File:
Sin-APnd_014-Ex1-5C-lcwgs-1-2.trna

- 11. The control region sequence.
File:
Sin-APnd_014-Ex1-5C-lcwgs-1-2.misc_feature
