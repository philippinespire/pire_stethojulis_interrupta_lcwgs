...
k2_angsd_not <- read.table("angsd_admix_notrans_neutral_fdr.admix.2.Q")
...
plot_q2_not <- 
  plotQ(as.qlist(q2_not), imgoutput = "sep", returnplot = TRUE, exportpath=getwd(), dpi=1000,
        ...
        showsp = TRUE, spbgcol = "white", splab = "K = 2", splabsize = 3, basesize = 3,
        showyaxis = TRUE, showticks = FALSE, indlabsize = 3, ticksize = 0.5, 
        grplab = meta.data, linesize = 0.3, pointsize = 3, showgrplab = FALSE, grplabspacer = 0.1,)
print(plot_q2_not) # save to your directory

admix_global <- image_read("run1.png")
print(admix_global)

# mv run1.png plots/Sin_plot_admix_neutral_fdr_k2.png

q2_not <- list(k2_angsd_not)
plot_q2_not <- 
  plotQ(as.qlist(q2_not), imgoutput = "sep", returnplot = TRUE, exportpath=getwd(), dpi=1000,
        clustercol = c("#F8766D", "#00BFC4"),
        showsp = TRUE, spbgcol = "white", splab = "K = 2", splabsize = 2,
        showyaxis = TRUE, showticks = FALSE, indlabsize = 4, ticksize = 0.5, 
        grplab = meta.data, linesize = 0.3, pointsize = 2, showgrplab = FALSE, grplabspacer = 0.1,)
print(plot_q2_not) # save to your directory
