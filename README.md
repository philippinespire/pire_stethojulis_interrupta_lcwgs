...
1st sequencing run fq.gz processing done by Gianna Mazzei (July 2024).
* APnd
* CPnd
...
## [ATLAS_Sin](https://github.com/philippinespire/pire_stethojulis_interrupta_lcwgs/tree/main/ATLAS_Sin)
