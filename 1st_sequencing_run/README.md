...
sh rename_duplicate_fasta_headers.sh MitoZ_output.fasta Sin_1st_MitoZ_output_cleaned.fasta
```

Rename files to include the species code and the sequencing run.
```
mv MitoZ_success.txt Sin_1st_MitoZ_success.txt
mv MitoZ_failure_lowdepth.txt Sin_1st_MitoZ_failure_lowdepth.txt
mv MitoZ_output.fasta Sin_1st_MitoZ_output.fasta
```
